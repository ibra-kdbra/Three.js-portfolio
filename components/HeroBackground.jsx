...
function HeroBackground() {
  return (
    <div
      className="absolute top-0 w-full h-[100svh] bg-gradient-to-b from-opacity-[6.33%] 
    dark:from-[#322d6d] from-[#b0afb1] to-opacity-[39.13%] dark:to-[#663182] to-[#51afda]"
    >
      ...
      <HeroSvg
        className="md:w-full w-full h-[1200px] wave md:top-[100dvh] md:left-0 top-[520px] 
      dark:text-[#181826] text-[#4e2f84]"
      />
    </div>
  );
}
