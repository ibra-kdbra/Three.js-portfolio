    ...
    >
      ...
      >
        <div>
          ...
          Engineering, I’ve had the opportunity to work as a Backend Developer
          at Geeks for Geeks, focusing on building scalable and efficient web
          applications. My experience includes working with frameworks like
          Node.js, React, Next.js, Vue.js, Three.js, and NestJS, always striving
          to apply the best practices in development. With a strong foundation
          in data structures, algorithms, and AI-driven solutions, the goal is
          to solve technical challenges while continuously learning and
          improving. It’s always a pleasure to collaborate on projects that
          bring ideas to life in meaningful ways.
        </div>
